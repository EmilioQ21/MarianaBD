  ...
  const DAYS = [
    ...
    { day: 12, date: "23 de mayo",  text: "omg es dia de qualy y kimi antonelli se acaba de sacar la pole position, no lo puedo fakin creer. Anyways como va tu sabado bonito pretty? i hope good, perdón por no ir hoy a lo del papá de Karla, realmente me hubiera gustado, pero vi a mi padre muy emocionado por pasar el dia y la tarde juntos y despues de que se echaron a perder los planes originales con lo de su pie, si se puso triston, pero bueno espero que haga sus famosas crepas pronto porque i want to try them jijijijija, te amo mucho pretty have fun, aqui hay un pase para el lunes jijiji.",image: "https://lh3.googleusercontent.com/d/13zq8HiHl2zZc2gr6EXth4K9iL8uowPDF"},
    { day: 13, date: "24 de mayo",  text: "Dominguito de chill de carreriña, uno antes de entrar a verano, que haras hoy? Aqui otra fotito que me encanta de nosotros. me encanta que seas mi mejor amiga linda, me la paso increible contigo", image: "https://lh3.googleusercontent.com/d/1t1fqNig4ouGcCpI0ZtIPapp-aXD3JJAd" },
    { day: 14, date: "25 de mayo",  text: "Lunes y adivina que, ya estamos de vuelta en la escuela tristemente, y te acuerdas como hablamos de ir al gym? bueno si si fuimos hay que revolar el papoi (y talvez puedas usar tu pase) ",video: "lyVBFPJQ0KQ"},
    ...
    { day: 20, date: "31 de mayo",  text: "Ultimo dia de mayo, mañana ya sera el mes de tu cumpleaños, quiero que tengas un increible cumpleaños linda y recordarte que tienes mucha gente que te ama, empezando desde ayer, cada dia tendras un mensaje de una de ellas :)", driveVideo: "1cxOwywNLCX3CwakihpkFLIGOhgn5Cq7H" }, //DANNA DONE
    { day: 21, date: "1 de junio",  text: "Primer dia de JUNE!!, y que mejor manera de empezar el mes con un mensaje de Sofi :OO", driveVideo: "1JcnwC1H-veeLZcPf409OQ92a7YIUWCdk" }, //SOFI DONE
    ...
    { day: 23, date: "3 de junio",  text: "el 3 de junio tambien es conocido como el dia en el que Nat le manda un mensaje a Mariana, so here it is jijijijija", driveVideo: "1qxE2VUrjiklrxz54t-7kR_mdf9BZBOnI" }, //NAT DONE
    { day: 24, date: "4 de junio",  text: "Omg ya muchos mensajes ya me toca hablar a mi verdad? pues no guys ahora es el turno de ximena :o", driveVideo: "1svrEm7lc6wIChj4MPlNRbew0h_Jk86sv" }, 
